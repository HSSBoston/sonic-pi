...
live_loop :arppegio do
  sleep 4
  play_pattern ring(chord(:f3, :major))
  ##| sleep 4
  play_pattern ring(chord(:c3, :major))
  ##| sleep 4
  play_pattern ring(chord(:d3, :minor))
  ##| sleep 4
  play_pattern ring(chord(:bb3, :major))
  ##| sleep 4
  play_pattern ring(chord(:a3, :minor))
  ##| sleep 4
  play_pattern ring(chord(:eb3, :major))
  ##| sleep 4
  play_pattern ring(chord(:bb3, :major))
  ##| sleep 4
  play_pattern chord(:f3, :major)
end
